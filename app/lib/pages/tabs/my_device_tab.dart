...
class MyDeviceTab extends StatelessWidget { // TODO
  const MyDeviceTab();
      ...
      builder: (context, vm) {
        ...
        return ResponsiveListView(
          ...
          children: [
            ...
            /*
                私の端末のリストと追加ボタンを表示する．
                端末のリストのうち現在近くにないものはグレーアウトする．
                各端末について端末名，HOTPの共有鍵，HOTPカウンタの三つを保持する．
                共有鍵とカウンタは安全に（flutter_secure_storage）保持する．
                相互認証はファイルを送るタイミングでする．表示する時点ではしない．
               */
            if (vm.nearbyDevices.isEmpty) // TODO ここに私の他の端末のリスト
              const Padding(
