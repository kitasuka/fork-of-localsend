...
final myDeviceTabVmProvider = ViewProvider((ref) {
  ...
  return MyDeviceTabVm(
    ...
    onTapDevice: (context, device) async { // TODO
    ...
    onTapDeviceMultiSend: (context, device) async { // TODO
...
class MyDeviceTabInitAction extends AsyncGlobalAction {
  final BuildContext context;

  MyDeviceTabInitAction(this.context);
